...
#define FFMPEG_CONFIGURATION "--target-os=linux --cross-prefix=/Users/joffychim/code/ffmpeg/ffmpeg3.24/toolchain-android/bin/arm-linux-androideabi- --arch=arm --cpu=cortex-a8 --enable-runtime-cpudetect --enable-neon --sysroot=/Users/joffychim/code/ffmpeg/ffmpeg3.24/toolchain-android/sysroot --disable-bzlib --disable-sse --disable-avdevice --disable-filters --enable-filter=aformat --enable-filter=amix --enable-filter='palettegen,paletteuse' --enable-filter=crop --enable-filter=anull --enable-filter=aresample --enable-filter=trim --enable-filter=split --enable-filter=format --enable-filter=null --enable-filter=overlay --enable-filter=scale --enable-filter=setsar --enable-filter=amovie --enable-filter=volume --enable-filter=hstack --enable-filter=vstack --enable-filter=movie --enable-filter=blend --enable-filter='setpts,pad,overlay' --disable-decoders --disable-encoders --enable-decoder=h264 --enable-decoder=aac --enable-decoder=mp3 --enable-decoder='png,mjpeg' --enable-encoder='png,mjpeg,gif' --enable-encoder=aac --enable-encoder=libx264 --disable-muxers --disable-demuxers --enable-muxer=mp4 --enable-demuxer=h264 --enable-demuxer=mp3 --enable-demuxer=mov --enable-muxer=gif --enable-demuxer=image2 --enable-muxer=image2 --enable-demuxer=image_png_pipe --enable-demuxer=image_png_pipe --disable-protocols --enable-protocol=file --disable-parsers --enable-parser=aac --enable-parser=h264 --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-pic --enable-libx264 --enable-pthreads --enable-swscale --disable-debug --disable-ffserver --enable-version3 --enable-hardcoded-tables --disable-ffplay --disable-ffprobe --enable-cross-compile --enable-gpl --disable-yasm --enable-asm --disable-doc --disable-ffmpeg --disable-shared --enable-static --pkg-config=/Users/joffychim/code/ffmpeg/ffmpeg3.24/ffmpeg-pkg-config --prefix=/Users/joffychim/code/ffmpeg/ffmpeg3.24/build/armeabi-v7a-neon --extra-cflags='-I/Users/joffychim/code/ffmpeg/ffmpeg3.24/toolchain-android/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all -fPIC -DANDROID -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad' --extra-ldflags='-L/Users/joffychim/code/ffmpeg/ffmpeg3.24/toolchain-android/lib -Wl,-z,relro -Wl,-z,now -pie' --extra-libs=-lm --extra-cxxflags="
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/joffychim/code/ffmpeg/ffmpeg3.24/build/armeabi-v7a-neon/share/ffmpeg"
#define AVCONV_DATADIR "/Users/joffychim/code/ffmpeg/ffmpeg3.24/build/armeabi-v7a-neon/share/ffmpeg"
