...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        if (null != mEGLDisplay && !mEGLDisplay.equals(EGL14.EGL_NO_DISPLAY)) {
        ...
        if (null == mEGLContext || mEGLContext.equals(EGL14.EGL_NO_CONTEXT)) {  // GLES 2 only, or GLES 3 attempt failed
